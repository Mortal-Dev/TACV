...
public partial struct VehicleEnterSystem : ISystem
{
    ...
    public static void ServerRecieveClientRequestVehicleEnter(ushort clientId, Message message)
    {
        ...
        {
            Debug.Log($"unable to find seat {seatPosition} in client seat request");
            return;
        }
        ...
        void SendOwnershipMessage()
        {
            ...
            changeVehicleOwnershipMessage.Add(entityManager.GetComponentData<NetworkedEntityComponent>(vehicleEntity).networkEntityId);
            changeVehicleOwnershipMessage.Add(clientId);
